...
public class GamePlay {
    ...
    public static int indexRow(int index){
    	if(index < 10)
    		return 0;
    	else if(index < 20)
    		return 1;
    ...
    public static int indexCol(int index){
    ...
    public static int[] computerMove(int player, Board board){
    ...
    public static int checkForTwoInARowHorizontal(int player, Board board)
    {
	...
	*/
    ...
    public static int checkForForks(int player, Board board){
	if(player == board.getPlayerAtRowCol(0, 0) 
	   && player == board.getPlayerAtRowCol(2, 2)
	   && board.isCellEmpty(0, 1)
	   && board.isCellEmpty(0, 2)
    ...
    //WHY????
    public static int checkIfCenterIsEmpty(int player, Board board){
    ...
    public static int checkForEmptyCorner(int player, Board board){
    ...
    public static int checkForEmptySide(int player, Board board){
